...
public class Character {
	...
	public enum Special {
		AIM, STAMINA, FEAR, REPUTATION, SHORT_LEGS, CAVE_KNOWLEDGE, ELUSIVENESS, ARCHER, BARTER, CLEVE
	};

	private String type; // this is just their name, will be used to compare
							// between them

	String[] startSpots = new String[1]; // this will be the location on the map
											// where this character starts, it
											// will be used to choose where to
											// start

	// this will be the startSpot at the beginning
	protected int currentLocation;// integer value of mapTile/clearing

	protected int weight; // this represents character's weight/vulnerability.
	...
	// this will hold all items character is holding but not using: treasure,
	// deadCharacters weapons and armors
	...
	// Development are the stages of the characters life, only used in the
	// optional rules
	protected Weapon weapon = new Weapon(); // weapon moved to individual
											// profiles
	protected Armor[] defense = new Armor[0];// armor
	public boolean shieldActive = false;// used in combat to determine if ask
										// direction
	...
	public void setWeapon(Weapon weapon) {
		this.weapon = weapon;
		belongings = ArrayUtils.add(belongings, weapon);
	}
	...
	public void setDefense(Armor[] defense) {
		...
		//System.out.println("Defense length = "+defense.length);
		for(int i=0; i<defense.length;i++){
			belongings = ArrayUtils.add(belongings, defense[i]);
		}
	}
