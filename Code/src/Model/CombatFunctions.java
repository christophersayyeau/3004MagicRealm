...
public class CombatFunctions{	//combat resolution, see page 28 and page 5 of flowchart
	...
	public static void resolveCombat(GUI view, Player player, Player opponent, boolean cheating) {	//TODO testing, this will need to be extensively tested when out of TODOs
