...
public class CombatDialog extends JDialog{
	...
	public CombatDialog(Player player) {
		   // super(parent, "My dialog", true);
		    ...
		    cp.add(new JLabel("Choose Attack Options"));
		  ...
		  //  smashButton.setActionCommand("Smash");	    
		    ...
		    //TODO now handle picking the Fight CHit used
		    ...
		    ok.addActionListener(new ActionListener() {
		      public void actionPerformed(ActionEvent e) {
		    	  System.out.println( directionGroup.getSelection());//TODO make their be changes to player
		    	  
		    	  //TODO make an if statement that prevents closing it unless both buttons selected
